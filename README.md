...
| 版本 | 行数 | 哲学 | 参数数 | P50 (示例 PD=2024-06) |
|------|------|------|--------|---------------------------|
...
├── LICENSE                 # MIT
├── versions/               # V18-V21 四个共识模型
│   ├── eb1a-predictor-v18.html
│   ├── eb1a-predictor-v19.html
│   ├── eb1a-predictor-v20.html
│   └── eb1a-predictor-v21.html
└── exploration/            # 教学 / 分析工具
    ├── candy-store-explainer.html
    ├── eb1-sensitivity-analysis.html
    └── garfield-factors-overview.html
```
